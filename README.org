...
Bumping them past the level of surrounding code forms also helps preserve the logical relationship between expression nesting and indentation, reducing visual noise from getting in the way of reading Lisp code.
